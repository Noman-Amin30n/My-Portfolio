    ...
    <>
      ...
      {/* Mobile menu */}
        ...
        >
          {/* Backdrop overlay */}
          <div
            className="absolute inset-0 bg-background/80 transition-all duration-200 backdrop-blur-xs"
          ...
          <div
            className={cn(
              "absolute right-0 top-0 bottom-0 w-[280px] h-full bg-background shadow-2xl transition-all duration-200 ease-in-out",
